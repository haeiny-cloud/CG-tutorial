...
매번 어떤 과목이든 한 개념에 대해서 수업시간에 배울 때는 굉장히 당연하다고 느끼는 것들이 실제로 구현하려고 하면 당연하지 않다는 것을 깨닫습니다.

현실에서는 빛을 비추면 그림자가 생긴다는 사실은 당연하지만, 그것을 computer에서 표현하는 것은 매우 어려운 문제인 것 같습니다.

우리가 게임을 플레이하면서 주의깊게 생각하지 않는 주변 사물들이 사실은 엄청난 계산들과 조정에 의해서 표현되고 있다는 것을 깨달았고, 현직 개발자들에 대한 존경심이 더더욱 생기는 기회였던 것 같습니다.
